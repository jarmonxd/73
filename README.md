  ...
  1. การเดินหน้า (Fd = Forward)
     ...
     - FdUntilLineGBeta(30, 30, 1);
       -> เดินหน้าไปหาเส้นแบบใช้ไจโร สําหรับใช้ในความเร็วสูงเพราะเมื่อถึงเส้นจะถอยหลังออกมาก่อนแล้วค่อยกลับเข้าไป ป้องกันการเลยเส้น
  ...
  *หมายเหตุ:
   ...
   - บอร์ด : https://github.com/INEXdev/ArduinoAVR/raw/main/package_inex_avr_index.json
  ========================================================================
    [ คู่มือการต่อสาย ]
    ...
    สายไจโร ->  ขาวบอร์ดต่อกับ ส้มไจโร ขาวไรโรต่อกับส้มบอร์ด